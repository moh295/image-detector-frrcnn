...
if __name__ == '__main__':
    ...
    temp_path='C:/Users/mom44/Google Drive (mohammed@clearimageai.com)/P01_107.MP4'
    images=get_frame(temp_path)

    for i in  range(int(images.totalFrames)):
        if i%2==0 and images[i] is not None:
